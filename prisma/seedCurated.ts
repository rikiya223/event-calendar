...
const CURATED: Curated[] = [
  ...
  // ── 空カテゴリ重点埋め（吹奏楽/合唱・紅葉・科学・オペラ・歌舞伎・酒）──
  ...([
    // [タイトル, 開始, 終了, カテゴリ, 会場, 都道府県, 説明]
    ["第74回 全日本吹奏楽コンクール 全国大会（大学・職場一般の部）", "2026-10-24T10:00:00+09:00", "2026-10-25T18:00:00+09:00", "吹奏楽・合唱", "府中の森芸術劇場（東京都府中市）", "東京都", "吹奏楽日本一を決める全国大会。"],
    ["第74回 全日本吹奏楽コンクール 全国大会（中学・高校の部）", "2026-10-31T10:00:00+09:00", "2026-11-01T18:00:00+09:00", "吹奏楽・合唱", "アクトシティ浜松（静岡県浜松市）", "静岡県", "吹奏楽日本一を決める全国大会の中学・高校の部。"],
    ["第79回 全日本合唱コンクール 全国大会", "2026-10-24T09:45:00+09:00", "2026-10-25T18:00:00+09:00", "吹奏楽・合唱", "フェスティバルホール（大阪市北区）", "大阪府", "合唱の頂点を競う全国大会。"],
    ["清水寺 紅葉ライトアップ（夜の特別拝観）2026", "2026-11-21T18:00:00+09:00", "2026-11-30T20:30:00+09:00", "紅葉", "清水寺（京都市東山区）", "京都府", "紅葉に包まれた境内をライトアップする秋の夜間特別拝観。"],
    ["特別展「いきもの超ワールド展」", "2026-07-11T09:00:00+09:00", "2026-10-12T17:00:00+09:00", "科学・自然", "国立科学博物館（東京都台東区）", "東京都", "NHK「ダーウィンが来た!」とコラボした生き物の特別展。"],
    ["特別展「生きものたちの性」", "2026-10-31T09:00:00+09:00", "2027-02-21T17:00:00+09:00", "科学・自然", "国立科学博物館（東京都台東区）", "東京都", "生物の「性」の多様さに迫る特別展。"],
    ["新国立劇場オペラ「イタリアのトルコ人」", "2026-10-02T18:00:00+09:00", "2026-10-12T13:00:00+09:00", "オペラ", "新国立劇場 オペラパレス（東京都渋谷区）", "東京都", "ロッシーニの喜劇オペラ。新国立劇場初上演の新制作。"],
    ["錦秋十月大歌舞伎（歌舞伎座）", "2026-10-02T11:00:00+09:00", "2026-10-20T16:00:00+09:00", "歌舞伎・能・狂言", "歌舞伎座（東京都中央区）", "東京都", "歌舞伎座の十月公演。昼夜2部制で上演。"],
    ["全国日本酒フェア2026", "2026-06-19T18:00:00+09:00", "2026-06-20T17:00:00+09:00", "酒・ワイン", "池袋サンシャインシティ（東京都豊島区）", "東京都", "全国45都道府県・1,000銘柄以上が集まる日本酒の利き酒イベント。"],
    ["和酒フェス2026（中目黒・秋）", "2026-11-07T11:00:00+09:00", "2026-11-08T20:00:00+09:00", "酒・ワイン", "中目黒高架下（東京都目黒区）", "東京都", "全国の日本酒・クラフトサケが集まる屋外の酒フェス。"],
  ] as const).map(([title, start, end, categoryName, venue, region, description]) => ({
    title,
    ...
    categoryName,
    description,
    sourceUrl: `manual:research7:${start.slice(0, 10)}:${title}`,
  })),

  // --- research8: 2026 夏〜秋の音楽フェス／ゲーム発売／アニメ／グルメ（薄いカテゴリの補充） ---
  {
    title: "ROCK IN JAPAN FESTIVAL 2026",
    occurrences: [
    ...
    venue: { name: "蘇我スポーツ公園", region: "千葉県" },
    categoryName: "フェス",
    description: "国内最大級のロックフェス。千葉・蘇我スポーツ公園で2週末・計5日間開催。",
    sourceUrl: "https://rijfes.jp/",
  },
  {
    title: "RISING SUN ROCK FESTIVAL 2026 in EZO",
    occurrences: [
      { start: "2026-08-14T13:00:00+09:00" },
      { start: "2026-08-15T13:00:00+09:00" },
    ],
    venue: { name: "石狩湾新港樽川ふ頭横 特設ステージ", region: "北海道" },
    categoryName: "フェス",
    description: "北海道・石狩で開かれるオールナイトの野外ロックフェス。",
    sourceUrl: "https://rsr.wess.co.jp/",
  },
  {
    ...
    venue: { name: "お台場 シンボルプロムナード公園", region: "東京都" },
    categoryName: "フェス",
    description: "お台場で開催される都市型ダンスミュージックフェス。",
    sourceUrl: "https://ultrajapan.com/",
  },
  {
    title: "京都大作戦2026",
    occurrences: [
      { start: "2026-07-04T09:00:00+09:00" },
      { start: "2026-07-05T09:00:00+09:00" },
    ],
    venue: { name: "京都府立山城総合運動公園 太陽が丘 特設野外ステージ", region: "京都府" },
    categoryName: "フェス",
    description: "10-FEET主催の野外ロックフェス。宇治・太陽が丘で2日間開催。",
    sourceUrl: "manual:research8:2026-07-04:京都大作戦2026",
  },
  {
    title: "MONSTER baSH 2026",
    occurrences: [
      { start: "2026-08-22T09:00:00+09:00" },
      { start: "2026-08-23T09:00:00+09:00" },
    ],
    venue: { name: "国営讃岐まんのう公園", region: "香川県" },
    categoryName: "フェス",
    description: "香川・まんのう公園で開催される夏の野外ロックフェス。",
    sourceUrl: "manual:research8:2026-08-22:MONSTERbaSH2026",
  },
  {
    title: "OCEAN PEOPLES'26",
    occurrences: [
      { start: "2026-07-04T10:00:00+09:00" },
      { start: "2026-07-05T10:00:00+09:00" },
    ],
    venue: { name: "稲毛海浜公園", region: "千葉県" },
    categoryName: "フェス",
    description: "海をテーマにした千葉・稲毛海浜公園の野外音楽フェス。",
    sourceUrl: "manual:research8:2026-07-04:OCEANPEOPLES26",
  },
  {
    title: "OSAKA GIGANTIC MUSIC FESTIVAL 2026（ジャイガ）",
    occurrences: [
      { start: "2026-07-25T10:00:00+09:00" },
      { start: "2026-07-26T10:00:00+09:00" },
      { start: "2026-08-01T10:00:00+09:00" },
      { start: "2026-08-02T10:00:00+09:00" },
    ],
    venue: { name: "舞洲スポーツアイランド", region: "大阪府" },
    categoryName: "フェス",
    description: "大阪・舞洲で2週末にわたり開催される野外音楽フェス。",
    sourceUrl: "manual:research8:2026-07-25:ジャイガ2026",
  },
  {
    title: "TOKYO ISLAND 2026",
    occurrences: [
      { start: "2026-10-10T10:00:00+09:00" },
      { start: "2026-10-11T10:00:00+09:00" },
      { start: "2026-10-12T10:00:00+09:00" },
    ],
    venue: { name: "海の森公園", region: "東京都" },
    categoryName: "フェス",
    description: "東京・海の森公園で開かれる音楽とカルチャーの島フェス。",
    sourceUrl: "manual:research8:2026-10-10:TOKYOISLAND2026",
  },
  {
    title: "京都音楽博覧会2026",
    occurrences: [
      { start: "2026-10-10T10:30:00+09:00" },
      { start: "2026-10-11T10:30:00+09:00" },
    ],
    venue: { name: "梅小路公園 芝生広場", region: "京都府" },
    categoryName: "フェス",
    description: "くるり主催、京都・梅小路公園の野外音楽フェス。",
    sourceUrl: "manual:research8:2026-10-10:京都音楽博覧会2026",
  },
  {
    title: "Animelo Summer Live 2026 -Messenger-",
    occurrences: [
      { start: "2026-07-10T15:00:00+09:00" },
      { start: "2026-07-11T14:00:00+09:00" },
      { start: "2026-07-12T14:00:00+09:00" },
    ],
    venue: { name: "幕張メッセ", address: "千葉県千葉市美浜区中瀬2-1", region: "千葉県" },
    categoryName: "フェス",
    description: "アニソンを中心とした大型ライブ。幕張メッセで3日間開催。",
    sourceUrl: "manual:research8:2026-07-10:アニサマ2026",
  },
  {
    title: "福山雅治 WE'RE BROS. TOUR 2026 DOME LIVE（東京）",
    occurrences: [
      { start: "2026-08-05T18:00:00+09:00" },
      { start: "2026-08-06T18:00:00+09:00" },
    ],
    venue: { name: "東京ドーム", address: "東京都文京区後楽1-3-61", region: "東京都" },
    categoryName: "ライブ",
    description: "福山雅治のドームツアー。東京ドーム2DAYS公演。",
    sourceUrl: "manual:research8:2026-08-05:福山雅治東京ドーム",
  },
  {
    title: "グランブルーファンタジー リリンク -Endless Ragnarok-",
    occurrences: [{ start: "2026-07-09T00:00:00+09:00" }],
    categoryName: "発売日",
    description: "人気アクションRPG『グランブルーファンタジー リリンク』の新章が発売（Switch2/PS5/PS4/PC）。",
    sourceUrl: "manual:research8:2026-07-09:グラブルリリンクER",
  },
  {
    title: "プロ野球スピリッツ2026",
    occurrences: [{ start: "2026-07-16T00:00:00+09:00" }],
    categoryName: "発売日",
    description: "コナミの野球ゲーム『プロ野球スピリッツ』最新作の発売日（PS5/PC）。",
    sourceUrl: "manual:research8:2026-07-16:プロスピ2026",
  },
  {
    title: "スプラトゥーン レイダーズ",
    occurrences: [{ start: "2026-07-23T00:00:00+09:00" }],
    categoryName: "発売日",
    description: "『スプラトゥーン』シリーズの新作が発売（Nintendo Switch 2）。",
    sourceUrl: "manual:research8:2026-07-23:スプラレイダーズ",
  },
  {
    title: "ゼノブレイド ディフィニティブ・エディション（Switch 2 Edition）",
    occurrences: [{ start: "2026-07-30T00:00:00+09:00" }],
    categoryName: "発売日",
    description: "名作RPG『ゼノブレイド ディフィニティブ・エディション』のSwitch 2版が発売。",
    sourceUrl: "manual:research8:2026-07-30:ゼノブレDE_S2",
  },
  {
    title: "じゅじゅフェス2026（TVアニメ『呪術廻戦』）",
    occurrences: [
      { start: "2026-08-29T11:00:00+09:00" },
      { start: "2026-08-30T11:00:00+09:00" },
    ],
    categoryName: "アニメイベント",
    description: "TVアニメ『呪術廻戦』のファンイベント。声優ステージや展示を予定。",
    sourceUrl: "manual:research8:2026-08-29:じゅじゅフェス2026",
  },
  {
    title: "オクトーバーフェスト2026 in 芝公園 〜Autumn〜",
    occurrences: [{ start: "2026-09-11T11:00:00+09:00", end: "2026-09-23T21:00:00+09:00" }],
    venue: { name: "都立芝公園4号地", region: "東京都" },
    categoryName: "酒・ワイン",
    description: "本場ミュンヘン公認のドイツビールの祭典。芝公園で約2週間開催。",
    sourceUrl: "https://www.oktober-fest.jp/",
  },
];
